...
int startFillValue = 1;
int startRow = 0;
int startCol = 0;


/// Рекурсивное заполнение массива начиная с элемента [0,0] последовательностью чисел
/// от 1, .. , N по спирали движение влево, вниз, вправо, вверх. Смена направления производится 
